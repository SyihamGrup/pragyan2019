  ...
  Widget build(BuildContext context) {
    void land_prep(BuildContext context)
    {
      ...
      var alert= new AlertDialog(
        ...
        content: Text("${data["Crops"]["rice"]["soil"].toString()}"),
        actions: <Widget>[
          FlatButton(
            child: new Text("ok"),
    ...
    Map <dynamic,dynamic> data= ob.getJson();
      var alert= new AlertDialog(
        ...
        content: Text("Seed Types- ${data["Crops"]["rice"]["varieties"].toString()}\n "
            "Temperature- ${data["Crops"]["rice"]["temp"].toString()}°C\n"" Rainfall -${data["Crops"]["rice"]["rainfall"].toString()}m"),
        actions: <Widget>[
          FlatButton(
            child: new Text("ok"),
            onPressed: ()=>Navigator.pop(context),
    ...
    void crop_growth(BuildContext context , String message)
    {
      var alert= new AlertDialog(
    ...
    void harvest(BuildContext context , String message)
    {
      var alert= new AlertDialog(
        title: Text("Alert Dialog"),
        content: Text(message),
